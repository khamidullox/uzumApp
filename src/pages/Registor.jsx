...
function Registor() {
  ...
  return (
    <div className="flex items-center gap-10 ransition-shadow h-screen">
      <figure
        className={` w-[70%] h-screen  transition-shadow transform  flex items-center justify-center flex-col`}
      >
      ...
      <div className=" flex items-cent gap-5  justify-center ml-10 flex-col">
        ...
        <Link className="link link-success text-xs text-center" to="/login">
          Login
        </Link>
      </div>
    </div>
